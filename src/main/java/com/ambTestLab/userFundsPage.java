...
public class userFundsPage {
    ...
    public static By nameOfTheCardHolders = By.xpath("//div[@id='fundsContainer']//div[contains(@class,'pro-name')]");
    public static By addButton = By.xpath("//div[contains(@class,'doc-content flex-grow')]//button//span[text()='Add']");
    public static By buyNowButton = By.xpath("//div[@class='doc-content flex-grow-1']//button//span[text()='Buy Now']");
